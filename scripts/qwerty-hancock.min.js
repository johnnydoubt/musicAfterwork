...
!function() {
    var a = this,
        ...
        i = function(a) {
            ...
            d = {
                ...
                whiteKeyColour: user_settings.whiteKeyColour || "grey",
                blackKeyColour: user_settings.blackKeyColour || "whitesmoke",
                activeColour: user_settings.activeColour || "yellow",
                borderColour: user_settings.borderColour || "whitesmoke",
        ...
        l = function(a) {
            null !== a && ("white" === a.getAttribute("data-note-type")
                ? a.style.backgroundColor = d.whiteKeyColour
                : a.style.backgroundColor = d.blackKeyColour)
        },
        m = function(a) {
            var b,
                c = 0,
        ...
        r = function(a, b) {
            "li" == a.tagName.toLowerCase() && (e = !0, k(a), b(a.title, j(a.title)))
        },
        s = function(a, b) {
            "li" == a.tagName.toLowerCase() && (e = !1, l(a), b(a.title, j(a.title)))
        },
        t = function(a, b) {
            e && (k(a), b(a.title, j(a.title)))
        },
        u = function(a, b) {
            e && (l(a), b(a.title, j(a.title)))
        },
        v = function(a) {
        ...
        C = function(a, b) {
            var c;
            a.keyCode in f || (f[a.keyCode] = !0, "undefined" != typeof g[a.keyCode] && (c = B(a.keyCode), b(c, j(c)), k(document.getElementById(c))))
        },
        D = function(a, b) {
            var c;
            delete f[a.keyCode],
            "undefined" != typeof g[a.keyCode] && (c = B(a.keyCode), b(c, j(c)), l(document.getElementById(c)))
        },
        E = function(a) {
    ...
    "undefined" != typeof exports
        ? ("undefined" != typeof module && module.exports && (exports = module.exports = G), exports.QwertyHancock = G)
        : a.QwertyHancock = G
}(this);
